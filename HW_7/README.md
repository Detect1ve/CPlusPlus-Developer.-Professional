...
Along with the console output, the blocks should be saved in separate files named bulk1517223860.log , where 1517223860 is the time of receiving the first command from the block. One file per block.
