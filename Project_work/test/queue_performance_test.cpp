    ...
    const int queueSize)
{
    ...
    Queue<int> queue(queueSize, QueueMode::SINGLE_PRODUCER_SINGLE_CONSUMER);
    ...
    const int numConsumers)
{
    ...
    double itemsPerSecond;
    Queue<int> queue(queueSize, QueueMode::MULTI_PRODUCER_MULTI_CONSUMER);
    ...
    const int numPriorities)
{
    ...
    int consumed = 0;
    Queue<int, int> queue(0, QueueMode::MULTI_PRODUCER_MULTI_CONSUMER, true);
...
void compareQueueTypes(const int numItems)
{
    ...
    Queue<int, int> priorityQueue(0, QueueMode::MULTI_PRODUCER_MULTI_CONSUMER, true);
