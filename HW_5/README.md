...
The main emphasis should be on the controller pattern (MVC) and polymorphism. Functions that are GUI handlers should be collected in one file with the `main` function.
...
**The task is considered successful if** all files have passed the compilation stage, all classes are covered by diagrams, and the code has successfully passed the analysis.
